        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-background/70 text-sm leading-relaxed">
              Izrađujemo moderne i pristupačne sajtove za male lokalne biznise u Srbiji. 
              Vaš uspeh online počinje ovde.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/o-nama" className="text-background/70 hover:text-background text-sm transition-colors">
                  O nama
                </Link>
              </li>
              <li>
                <Link to="/paketi" className="text-background/70 hover:text-background text-sm transition-colors">
                  Paketi
                </Link>
              </li>
              <li>
                <Link to="/portfolio" className="text-background/70 hover:text-background text-sm transition-colors">
                  Portfolio
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="text-background/70 text-sm">Responzivni sajtovi</li>

        ...
        <div className="section-container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground">
              Imate pitanje ili želite da pokrenete projekat? 
              ...
              {isSubmitted ? (
                <div className="card-elevated p-8 text-center">
                  ...
                  <p className="text-muted-foreground">
                    Vaša poruka je uspešno poslata. Javićemo vam se u najkraćem roku.
                  </p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="salon">Frizerski/Kozmetički salon</option>
            ...
            <div>
              ...
              <div className="space-y-6 mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@webino.rs" className="text-muted-foreground hover:text-primary transition-colors">
                      info@webino.rs
                    </a>
                  </div>
                </div>
              ...
              <div className="card-elevated p-6">
                ...
                <ul className="space-y-2 text-muted-foreground">
                  ...
                  <li className="flex justify-between">
                    <span>Nedelja</span>
                    <span className="font-medium text-foreground">Zatvoreno</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="mt-6 p-4 bg-primary/5 rounded-lg border border-primary/10">
                <p className="text-sm text-muted-foreground">
                  <span className="font-semibold text-foreground">💡 Besplatna konsultacija:</span>{" "}
                  Prvi razgovor je potpuno besplatan. Pozovite nas ili pošaljite poruku i zajedno ćemo pronaći najbolje rešenje za vaš biznis.
                </p>
              </div>
            </div>
          </div>

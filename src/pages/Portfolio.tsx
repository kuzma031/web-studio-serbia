...
const projects = [
  {
    ...
    description:
      "Moderan jednostranični sajt za frizerski salon u Beogradu. Sajt uključuje galeriju radova, cenovnik i online zakazivanje.",
    image:
  ...
  },
  {
    ...
    category: "Restoran",
    description:
      "Sajt za tradicionalni restoran sa jelovnikom, galerijom enterijera i integracijom sa Google mapom za lakšu navigaciju.",
    image:
  ...
  },
  {
    ...
    description:
      "Profesionalan sajt za stomatološku ordinaciju sa prikazom usluga, timom lekara i mogućnošću online zakazivanja.",
    image:
  ...
  },
  {
    ...
    description:
      "Dinamičan sajt za fitnes studio sa rasporedom treninga, cenama članarina i kontakt formom za upis.",
    image:
  ...
  },
  {
    ...
    description:
      "Jednostavan i pregledan sajt za auto servis sa listom usluga, kontakt informacijama i radnim vremenom.",
    image:
  ...
  },
  {
    ...
    category: "Cvećara",
    description:
      "Sajt za cvećaru sa galerijom aranžmana, mogućnošću naručivanja i informacijama o dostavi.",
    image:
          ...
          <div className="section-container">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="text-muted-foreground mb-8">
                Kontaktirajte nas i razgovarajmo o vašem projektu. Rado ćemo vam
                pomoći da napravite sajt koji će predstaviti vaš biznis na
                najbolji način.
              </p>
